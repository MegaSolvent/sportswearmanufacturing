...
import './style.css'
// carousel images 
import img1 from "../../Images/cycling/Ultimate-Customization-and-First-Class-Fabrics.jpg";
import img2 from "../../Images/cycling/Ultimate-Customization-and-First-Class-Fabrics2.jpg";
import img3 from "../../Images/cycling/Ultimate-Customization-and-First-Class-Fabrics3.jpg";
import img4 from "../../Images/cycling/cycling4.png";

import bgBack from "../../Images/Sweatsuit/bgback.jpg"
import bgImage from "../../Images/cycling/Choose-Us-to-Build-a-Strong-Clothing-Line.jpg"
import Cycliwear from "../../Images/cycling/Premium-Cycling-Wear-Smooth-and-Comfortable-Ride.jpg";
import Cyclingsuit from "../../Images/cycling/banner.jpg";
    ...
    return (
        <div className="textile-services-page">
            ...
            <section>
                ...
                <div className='huntingapparel' style={slideStyle(Cyclingsuit)}>
                    <div style={overlayStyle}></div>
                    <div style={contentStyle}>
                        <h1 className="fw-bold mb-3 display-5">Custom Cycling Clothing Manufacturer in The USA</h1>
                ...
                <Container>
                    <Row >
                        <Col md={6} className="position-relative ">
                            <img src={Cycliwear} alt="Main Textile" className="img-fluid rounded shadow" />
